...
const { requestToken, callback, ConnctedStatus } = require('../controllers/garminController');
const { checkEmail, getSummary, getHeartRate, getBloodPressure } = require('../controllers/garminDataController');
